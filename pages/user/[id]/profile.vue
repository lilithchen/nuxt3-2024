    ...
    <div class="col-12 col-md-5">
      <section class="rounded-3xl d-flex flex-column gap-6 gap-md-10 p-6 p-md-10 bg-neutral-0">
        ...
        <div class="d-flex flex-column gap-4 gap-md-6">
          ...
          <button :class="{ 'd-none': !isEditPassword }" class="btn btn-neutral-40 align-self-md-start px-8 py-4 text-neutral-60 rounded-3" type="button">儲存設定</button>
        </div>
      </section>
    </div>
      ...
      <section class="rounded-3xl d-flex flex-column gap-6 gap-md-10 p-6 p-md-10 bg-neutral-0">
        ...
        <div class="d-flex flex-column gap-4 gap-md-6">
          ...
          <div class="fs-8 fs-md-7">
            ...
            <span class="form-control pe-none p-0 text-neutral-100 fw-bold border-0" :class="{ 'd-none': isEditProfile }">1990 年 8 月 15 日</span>
          ...
          <div class="fs-8 fs-md-7">
            ...
            <span class="form-control pe-none p-0 text-neutral-100 fw-bold border-0" :class="{ 'd-none': isEditProfile }">高雄市新興區六角路 123 號</span>
        ...
        <button :class="{ 'd-none': !isEditProfile }" class="btn btn-neutral-40 align-self-md-start px-8 py-4 text-neutral-60 rounded-3" type="button">儲存設定</button>
      </section>
    </div>
  </div>
</template>
