            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-5">
                <div class="card-body pe-md-10 py-md-10">
                  ...
                  <p class="card-text mb-6 mb-md-10 fs-8 fs-md-7 fw-medium text-neutral-80">享受高級的住宿體驗，尊爵雙人房提供給您舒適寬敞的空間和精緻的裝潢。</p>
                  ...
                  <div class="d-flex justify-content-between align-items-center fs-7 fs-md-5 text-primary-100">
                    ...
                    <NuxtLink to="/rooms/a" class="icon-link icon-link-hover text-primary-100">
            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-5">
                <div class="card-body pe-md-10 py-md-10">
                  ...
                  <p class="card-text mb-6 mb-md-10 fs-8 fs-md-7 fw-medium text-neutral-80">景觀雙人房擁有絕美的高雄市景觀，讓您在舒適的環境中欣賞城市之美。</p>
                  <ul class="d-flex gap-4 mb-6 mb-md-10 list-unstyled">
                    <li class="card-info px-4 py-5 border border-primary-40 rounded-3">
                      <Icon class="mb-2 fs-5 text-primary-100" icon="fluent:slide-size-24-filled" />
                  ...
                  <div class="d-flex justify-content-between align-items-center fs-7 fs-md-5 text-primary-100">
                    <p class="mb-0 fw-bold">NT$ 10,000</p>
                    <NuxtLink to="/rooms/b" class="icon-link icon-link-hover text-primary-100">
                      <Icon class="bi fs-5" icon="mdi:arrow-right" />
                    </NuxtLink>
                  </div>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-5">
                <div class="card-body pe-md-10 py-md-10">
                  ...
                  <div class="d-flex justify-content-between align-items-center fs-7 fs-md-5 text-primary-100">
                    <p class="mb-0 fw-bold">NT$ 10,000</p>
                    <NuxtLink to="/rooms/c" class="icon-link icon-link-hover text-primary-100">
                      <Icon class="bi fs-5" icon="mdi:arrow-right" />
                    </NuxtLink>
                  </div>
                </div>
            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-5">
                <div class="card-body pe-md-10 py-md-10">
                  ...
                  <p class="card-text mb-6 mb-md-10 fs-8 fs-md-7 fw-medium text-neutral-80">景觀尊榮家庭房不僅有寬敞的空間，還有絕美的市景視野，是帶給家庭最尊榮的待遇。</p>
                  <ul class="d-flex gap-4 mb-6 mb-md-10 list-unstyled">
                    <li class="card-info px-4 py-5 border border-primary-40 rounded-3">
                      <Icon class="mb-2 fs-5 text-primary-100" icon="fluent:slide-size-24-filled" />
                  ...
                  <div class="d-flex justify-content-between align-items-center fs-7 fs-md-5 text-primary-100">
                    <p class="mb-0 fw-bold">NT$ 10,000</p>
                    <NuxtLink to="/rooms/d" class="icon-link icon-link-hover text-primary-100">
                      <Icon class="bi fs-5" icon="mdi:arrow-right" />
                    </NuxtLink>
                  </div>
                </div>
