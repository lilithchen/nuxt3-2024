            ...
            <div class="row">
              <div class="col-12 col-lg-7">
                <ClientOnly
                  ...
                  >
                    <swiper-slide v-for="img in room.imageUrlList" :key="img">
                      <picture>
                        <source :srcset="img" media="(min-width: 768px)" />
                        <img class="w-100 object-fit-cover" :src="img" loading="lazy" :alt="room.name" />
                      </picture>
                    </swiper-slide> </swiper
                ></ClientOnly>
              </div>
              <div class="col-12 col-lg-5">
                <div class="card-body pe-md-10 py-md-10">
                  ...
                  <div class="d-flex justify-content-between align-items-center fs-7 fs-md-5 text-primary-100">
                    ...
                    <NuxtLink :to="`/rooms/${room._id}`" class="icon-link icon-link-hover text-primary-100">
