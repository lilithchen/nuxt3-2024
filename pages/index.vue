...
const { data: culinaryData, error: culinaryError } = await useFetch('https://freyja-l47x.onrender.com/api/v1/home/culinary', {
  transform: (res) => res?.result || [],
});
</script>
...
<template>
  <main class="overflow-hidden">
    <section class="hero position-relative">
      ...
      >
        <swiper-slide v-for="room in roomsData" :key="room">
          <picture>
            <source :srcset="room.imageUrl" media="(min-width:576px)" />
            <img class="hero-img" :src="room.imageUrl" alt="hero banner" />
          </picture>
        </swiper-slide>
      </swiper>
      ...
      <div class="hero-wrapper d-flex flex-column justify-content-center align-items-center flex-md-row justify-content-md-between gap-md-10 w-100 px-md-20 position-absolute z-2">
        ...
        <div class="hero__intro position-relative">
          <div class="hero__intro-content">
            ...
            <NuxtLink to="/rooms" class="btn btn-neutral-0 d-flex justify-content-end align-items-center gap-3 w-100 text-end text-neutral-100 fs-5 fw-semibold border-0">
              立即訂房
              <div class="cta-deco" />
            </NuxtLink>
          </div>
      ...
      <div class="container position-relative">
        <div class="row">
          ...
          <div class="col-12 col-md-10 d-flex flex-column gap-10">
            <p v-if="newsError">{{ newsError.message }}</p>
            <div v-for="news in newsData" :key="news._id" class="card bg-transparent border-0">
              <div class="d-flex flex-column flex-md-row align-items-center gap-6">
                <picture>
                  <source :srcset="news.image" media="(min-width: 576px)" />
                  <img :src="news.image" class="w-100 rounded-3" :alt="news.imgAlt" />
                </picture>
      ...
      <div class="container p-0">
        <div class="about-content p-6 p-md-20 mt-10 ms-10 me-5 mt-md-20 mx-md-auto text-neutral-0">
          ...
          <div class="d-flex flex-column gap-4 gap-md-10 fw-medium">
            ...
            <p class="mb-0 fs-8 fs-md-7">享樂酒店，不僅是您在高雄的住宿之選，更是您感受高雄魅力的最佳舞台。我們期待著您的蒞臨，讓我們共同編織一段難忘的高雄故事。</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="room-intro position-relative px-3 py-20 px-md-0 py-md-30 bg-neutral-120">
      <div class="d-flex flex-column flex-md-row justify-content-center align-items-center justify-content-md-start align-items-md-end gap-6 gap-md-20">
        ...
        >
          <swiper-slide v-for="room in roomsData" :key="room._id">
            <picture>
        ...
        <div class="room-intro-content text-neutral-0">
          <h2 class="mb-2 mb-md-4 fw-bold">{{ roomsData[activeIndex].name }}</h2>
          <p class="mb-6 mb-md-10 fs-8 fs-md-7">{{ roomsData[activeIndex].description }}</p>
          <div class="mb-6 mb-md-10 fs-3 fw-bold">NT$ {{ roomsData[activeIndex].price }}</div>
          <NuxtLink
            :to="`/rooms/${roomsData[activeIndex]._id}`"
    ...
    <section class="delicacy position-relative py-20 py-md-30 bg-primary-10">
      <div class="container">
        ...
        <div class="row flex-nowrap overflow-x-auto">
          <div v-for="culinary in culinaryData" :key="culinary._id" class="col-10 col-md-6 col-xl-4">
            <div class="card position-relative border-0 rounded-3">
              ...
              <div class="card-body position-absolute bottom-0 p-4 p-md-6 rounded-bottom-3 text-neutral-0">
                ...
                <p class="card-text fs-8 fs-md-7">{{ culinary.description }}</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container pt-20 pb-10 pt-md-30 pb-md-20">
        ...
        <div class="row gap-6 gap-md-0">
          ...
          <div class="col-12 col-md-4 text-neutral-0">
            ...
            <p class="mb-0 fs-8 fs-md-7">如果您選擇自行開車，可以透過國道一號下高雄交流道，往市區方向行駛，並依路標指示即可抵達「享樂酒店」。飯店內設有停車場，讓您停車方便。</p>
          </div>
          <div class="col-12 col-md-4 text-neutral-0">
