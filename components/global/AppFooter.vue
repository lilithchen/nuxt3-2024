        ...
        <div class="d-flex flex-column flex-md-row gap-4 gap-md-20">
          <address class="d-flex flex-column mb-0">
            <p class="mb-4 mb-md-10 fw-bold text-neutral-0">
              TEL
              <a class="d-block mt-2 text-neutral-40 fs-8 fs-md-7 fw-normal text-decoration-none" href="tel:+886-7-1234567">+886-7-1234567</a>
            </p>

            <p class="mb-0 fw-bold text-neutral-0">
              FAX
              <a class="d-block mt-2 text-neutral-40 fs-8 fs-md-7 fw-normal text-decoration-none" href="fax:+886-7-1234567">+886-7-1234567</a>
            </p>
          </address>
          <address class="d-flex flex-column mb-0">
            <p class="mb-4 mb-md-10 fw-bold text-neutral-0">
              MAIL
              <a class="d-block mt-2 text-neutral-40 fs-8 fs-md-7 fw-normal text-decoration-none" href="mailto:elh@hexschool.com">elh@hexschool.com</a>
            </p>

            <p class="mb-0 fw-bold text-neutral-0">
              WEB
              <a class="d-block mt-2 text-neutral-40 fs-8 fs-md-7 fw-normal text-decoration-none" href="https://www.elhhexschool.com.tw/" target="_blank"
